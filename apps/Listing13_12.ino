...
embedDIP::Image classImg;
embedDIP::Image confImg;
...
void allocImages() {
  inImg = embedDIP::Image(IMG_SIZE, IMG_SIZE, IMAGE_FORMAT_RGB888);
  classImg = embedDIP::Image(IMG_SIZE, IMG_SIZE, IMAGE_FORMAT_GRAYSCALE);
  confImg = embedDIP::Image(IMG_SIZE, IMG_SIZE, IMAGE_FORMAT_GRAYSCALE);
  visImg = embedDIP::Image(IMG_SIZE, IMG_SIZE, IMAGE_FORMAT_RGB888);
  overlayImg = embedDIP::Image(IMG_SIZE, IMG_SIZE, IMAGE_FORMAT_RGB888);
}
