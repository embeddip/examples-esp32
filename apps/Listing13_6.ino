...
void setup()
{
  ...
  if (createImageWH(TLFM_SEG_INPUT_WIDTH, TLFM_SEG_INPUT_HEIGHT,
                    IMAGE_FORMAT_GRAYSCALE, &inImg) != EMBEDDIP_OK ||
      createImageWH(TLFM_SEG_INPUT_WIDTH, TLFM_SEG_INPUT_HEIGHT,
                    IMAGE_FORMAT_GRAYSCALE, &maskImg) != EMBEDDIP_OK)
  {
