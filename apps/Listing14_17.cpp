...
embedDIP::Image visImg;
embedDIP::Image overlayImg;
...
bool prepareModelInput(embedDIP::Image &img, TfLiteTensor *input) {
...
void setup() {
  ...
  inImg = embedDIP::Image(INPUT_WIDTH, INPUT_HEIGHT, IMAGE_FORMAT_RGB888);
  grayImg = embedDIP::Image(INPUT_WIDTH, INPUT_HEIGHT, IMAGE_FORMAT_GRAYSCALE);
  visImg = embedDIP::Image(INPUT_WIDTH, INPUT_HEIGHT, IMAGE_FORMAT_RGB888);
  overlayImg = embedDIP::Image(INPUT_WIDTH, INPUT_HEIGHT, IMAGE_FORMAT_RGB888);
